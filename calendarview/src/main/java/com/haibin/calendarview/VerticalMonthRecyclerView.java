...
public class VerticalMonthRecyclerView extends RecyclerView {
    ...
    public static class VerticalMonthViewHolder extends ViewHolder {
    ...
    protected class VerticalMonthAdapter extends Adapter<VerticalMonthViewHolder> {
        ...
        public void onBindViewHolder(@NonNull VerticalMonthViewHolder viewHolder, int position) {
            ...
            if (currentMonthView != null) {
                currentMonthView.setText(year + "年" + (month < 10 ? ("0" + month) : month) + "月");
            }
